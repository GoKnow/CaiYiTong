...
+ (void)showStatus:(LCProgressHUDStatus)status text:(NSString *)text {
    ...
    switch (status) {
        ...
        case LCProgressHUDStatusSuccess: {
            ...
            UIImage *sucImage = [UIImage imageNamed:@"hud_success@2x.png"];
        ...
        case LCProgressHUDStatusError: {
            ...
            UIImage *errImage = [UIImage imageNamed:@"hud_error@2x.png"];
        ...
        case LCProgressHUDStatusInfo: {
            ...
            UIImage *infoImage = [UIImage imageNamed:@"hud_info@2x.png"];
